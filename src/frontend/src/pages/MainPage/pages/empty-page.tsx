...
const EMPTY_PAGE_TITLE = "Welcome to MACP Agent Builder";
const EMPTY_PAGE_DESCRIPTION = "Your new favorite way to build AI Agents";
const EMPTY_PAGE_DISCORD_DESCRIPTION =
  "Need help? Contact Jing Consult support";
